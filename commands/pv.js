...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    msg='`'+String(msg)+'`'
    user.user
      .send({embed:{color:'GREEN', description:`> Um admirador secreto enviou uma DM para você **${user}** \n\n${msg}`,footer:{text:'Duvidas? zap!help | developed by @anjosoff',icon_url:avatar+'.jpg'}}})
      .catch(() => message.channel.send({embed:{color:'RED', description:`Houve um erro ao enviar mensagem, verifique se a DM do destinatário está aberta!`,footer:{text:'Duvidas? zap!help | developed by @anjosoff',icon_url:avatar+'.jpg'}}}));
